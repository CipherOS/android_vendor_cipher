...
ALARM_PATH := vendor/cipher/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cipher/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cipher/prebuilt/common/media/audio/ringtones
