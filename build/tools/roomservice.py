...
# Copyright (C) 2022, CipherOS Project
#
...
custom_default_revision = "twelve-L"
custom_dependencies = "cipher.dependencies"
org_manifest = "CipherOS-devices"  # leave empty if org is provided in manifest
org_display = "CipherOS-devices"  # needed for displaying

default_manifest = ".repo/manifests/default.xml"
arrow_manifest = ".repo/manifests/snippets/arrow.xml"
cipher_manifest = ".repo/manifests/snippets/cipher.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    cipherm = load_manifest(cipher_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(arrowm, repo_path) != None:
             existing_m_project = exists_in_tree(arrowm, repo_path)
        elif exists_in_tree(cipherm, repo_path) != None:
             existing_m_project = exists_in_tree(cipherm, repo_path)
