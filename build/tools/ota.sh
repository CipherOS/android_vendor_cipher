...
echo ' "url":' "\"https://master.dl.sourceforge.net/project/CipherOS/Cipher-3.x/GRAVITY/"$CODENAME"/$(basename $(ls "$DIR"/out/target/product/"$CODENAME"/CipherOS-3*.zip))\","
echo ' "version":' "\"3.0-GRAVITY\""
echo "}"
echo "]"
echo "}"
