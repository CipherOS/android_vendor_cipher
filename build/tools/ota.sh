...
echo ' "url":' "\"https://master.dl.sourceforge.net/project/cipheros/Cipher-3.x/NOVA/"$CODENAME"/$(basename $(ls "$DIR"/out/target/product/"$CODENAME"/CipherOS-3*.zip))\","
echo ' "version":' "\"3.8-NOVA\""
echo "}"
echo "]"
echo "}"
