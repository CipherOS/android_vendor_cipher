...
echo ' "url":' "\"https://master.dl.sourceforge.net/project/cipheros/Cipher-3.x/STRIKE/"$CODENAME"/$(basename $(ls "$DIR"/out/target/product/"$CODENAME"/CipherOS-3*.zip))\","
echo ' "version":' "\"3.6-STRIKE\""
echo "}"
echo "]"
echo "}"
